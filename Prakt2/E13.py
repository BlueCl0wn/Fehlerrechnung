...
graph(F, v, xlabel='Frequenz in $Hz$', ylabel='Verstärkung', xlog=True)

# -----------------------------------
# v(R_E)
v = [3.260869565, 3.681818182, 4.045454545, 4.613636364, 5.244444444, 5.97826087, 7.409090909, 9.545454545, 12.04545455,
